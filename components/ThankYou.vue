			...
			<div class="inline-block align-bottom bg-white rounded-xl px-12 py-8 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full">
				<div>
					...
					<div class="mt-3 text-center sm:mt-5">
						...
						<div class="mt-3">
							<a href="https://t.me/parasolfinance" target="_blank" class="inline-flex justify-center w-full rounded-md border border-transparent shadow-sm px-4 py-2 bg-gradient-to-r from-purple-500 to-pink-600 hover:from-pink-600 hover:to-purple-500 text-base font-medium text-white hover:bg-pink-700 sm:text-sm">
